...
#region /title actionbar
    public static void Actionbar(Targets targets, TextComponent text) => FunctionBuilder.Add(Str.Title.Actionbar(targets, text));
    public static void Actionbar(Targets targets, TextComponent[] text) => FunctionBuilder.Add(Str.Title.Actionbar(targets, text));
    public static void Actionbar(string targets, TextComponent text) => FunctionBuilder.Add(Str.Title.Actionbar(targets, text));
    public static void Actionbar(string targets, TextComponent[] text) => FunctionBuilder.Add(Str.Title.Actionbar(targets, text));
#endregion
#region /title title
    public static void ShowTitle(Targets targets, TextComponent text) => FunctionBuilder.Add(Str.Title.ShowTitle(targets, text));
    public static void ShowTitle(Targets targets, TextComponent[] text) => FunctionBuilder.Add(Str.Title.ShowTitle(targets, text));
...
#region /title subtitle
    public static void Subtitle(Targets targets, TextComponent text) => FunctionBuilder.Add(Str.Title.Subtitle(targets, text));
    public static void Subtitle(Targets targets, TextComponent[] text) => FunctionBuilder.Add(Str.Title.Subtitle(targets, text));
    public static void Subtitle(string targets, TextComponent text) => FunctionBuilder.Add(Str.Title.Subtitle(targets, text));
    public static void Subtitle(string targets, TextComponent[] text) => FunctionBuilder.Add(Str.Title.Subtitle(targets, text));
#endregion
#region /title clear
    public static void Clear(Targets target) => FunctionBuilder.Add(Str.Title.Clear(target));
    public static void Clear(string target) => FunctionBuilder.Add(Str.Title.Clear(target));
#endregion
#region /title reset
    public static void Reset(Targets targets) => FunctionBuilder.Add(Str.Title.Reset(targets));
    public static void Reset(string targets) => FunctionBuilder.Add(Str.Title.Reset(targets));
#endregion
#region /title times
    public static void Times(Targets targets, string fadeIn, string stay, string fadeOut) => FunctionBuilder.Add(Str.Title.Times(targets, fadeIn, stay, fadeOut));
